            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-primary">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        {{ Form::model($auctioneerHouse, ['method'=>'PATCH', 'route' => ['auctioneer-houses.update', $auctioneerHouse->id]]) }}
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="address" value="{{ $auctioneerHouse->address }}" id="address" placeholder="Address">
                                </div>
                                <div class="form-group">
